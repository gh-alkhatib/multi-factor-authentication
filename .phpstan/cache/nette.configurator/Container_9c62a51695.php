...
class Container_9c62a51695 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_9c62a51695 $container)
			{
	...
	public function createServiceContainer(): Container_9c62a51695
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'ignoreErrors' => ['#Method .* return type with generic class .* does not specify its types#'],
